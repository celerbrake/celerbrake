...
RSpec.describe Celerbrake::Rack::Instrumentable do
  after { Celerbrake::Rack::RequestStore.clear }

  describe ".celerbrake_capture_timing" do
    let(:routes) { Celerbrake::Rack::RequestStore[:routes] }
    ...
    let(:klass) do
      Class.new do
        ...
        def method; end
        celerbrake_capture_timing :method

        def foo; end

        def method_with_arg(a); end
        celerbrake_capture_timing :method_with_arg

        def method_with_args(a, b); end
        celerbrake_capture_timing :method_with_args

        def method_with_vla(*args); end
        celerbrake_capture_timing :method_with_vla

        def method_with_args_and_vla(*args); end
        celerbrake_capture_timing :method_with_args_and_vla

        def method_with_kwargs(foo:, bar:); end
        celerbrake_capture_timing :method_with_kwargs

        def method_with!(val); end
        celerbrake_capture_timing :method_with!
        ...
        celerbrake_capture_timing :==

        def method_with_block
          yield(1)
        end
        celerbrake_capture_timing :method_with_block
        ...
        celerbrake_capture_timing :method_with_everything!
        ...
        celerbrake_capture_timing :writer_with_everything=
        ...
        celerbrake_capture_timing :prepended_method!
        ...
        celerbrake_capture_timing :prepended_writer=

        protected

        def a_protected_method; end
        celerbrake_capture_timing :a_protected_method

        def a_prepended_protected_method; end
        celerbrake_capture_timing :a_prepended_protected_method

        private

        def a_private_method; end
        celerbrake_capture_timing :a_private_method

        def a_prepended_private_method; end
        celerbrake_capture_timing :a_prepended_private_method
      end
    end
    ...
    it "returns the method name so other methods can use it" do
      expect(klass.celerbrake_capture_timing(:foo)).to be :foo
    end
    ...
    it "doesn't generate too many anonymous modules" do
      ...
      mod = klass.__send__("__celerbrake_capture_timing_module__")
    ...
    context "when request store doesn't have any routes" do
      ...
      it "doesn't store timing of the tracked method" do
        klass.new.method
        expect(Celerbrake::Rack::RequestStore.store).to be_empty
      end
    end
    ...
    context "when request store has a route" do
      ...
      it "attaches timing for an inherited method" do
        klass.celerbrake_capture_timing :dup
        klass.new.dup
      ...
      context "and when a custom label was provided" do
        let(:klass) do
          Class.new do
            ...
            def method; end
            celerbrake_capture_timing :method, label: 'custom label'
        ...
        it "returns the method name so other methods can use it" do
          expect(klass.celerbrake_capture_timing(:bar, label: :foo)).to be :bar
        end
      end
    end
  end
